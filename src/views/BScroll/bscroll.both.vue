  ...
  <div id="goodsComponents" v-if="demoList">
    <div class="content">
      <div class="meun-wrapper" ref='meunWrapper'>
        <ul>
          <li v-for='(item,index) in demoList' v-if="item.list.length !=0" class="menu-item"
      ...
      <div class="goods-wrapper" ref='foodsWrapper'>
        <ul>
          <li class="section-content food-list-hook" v-for="(item,index) in demoList" v-if="item.list.length !=0">
