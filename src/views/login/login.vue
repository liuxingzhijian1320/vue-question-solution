  ...
  <div class="login">
    ...
    <form class="form" @click.submit.prevent>
      <div class="input-div">
        ...
        <input type="text" id="name" class="input" name="name" v-model.trim='formData.name' placeholder="姓名">
      </div>
      <div class="input-div">
        <label for="phone" class="label">手机</label>
        <input type="text" id="phone" class="input" name="phone" v-model.trim='formData.phone' placeholder="手机号">
      </div>
