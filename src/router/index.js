...
const magicalCss = (resolve) => import("../views/magicalCss/magicalCss");
...
const searchAuto = (resolve) => import("../views/searchAuto/searchAuto");
...
const searchLocation = (resolve) => import("../views/map/searchLocation");
...
const mintuiPicker = (resolve) =>
  import("../views/mint-ui-picker/mint-ui-picker");

const filterActionsheet = (resolve) =>
  import("../views/filter_actionsheet/filter_actionsheet");

const filterActionsheetvuex = (resolve) =>
  import("../views/filter_actionsheet_vuex/filter_actionsheet_vuex");

const canvasStar = (resolve) => import("../views/canvas/star");

const mulSelect = (resolve) => import("../views/mulSelect/mulSelect");

const getJson = (resolve) => import("../views/getJson/getJson");

const H5ToApp = (resolve) => import("../views/H5ToApp/H5ToApp");
